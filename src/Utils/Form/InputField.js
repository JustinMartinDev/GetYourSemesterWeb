    ...
    render(){
        ...
        return(
            <React.Fragment>
                ...
                <input dataname={this.state.dataname} id={this.state.id} type={this.state.type} className={this.state.className} onChange={this.state.handleChange} defaultValue={this.state.defaultvalue}/>
